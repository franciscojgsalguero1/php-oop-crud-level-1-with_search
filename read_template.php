<?php
    ...
    echo "<form role='search' action='search.php'>";
        echo "<div class='input-group col-md-3 pull-left margin-right-1em'>";
            ...
            // si quitamos el require de la siguiente línea lo vuelve a buscar todo con el mismo botón
    ...
    echo "<div class='right-button-margin'>";
        echo "<a href='create_product.php' class='btn btn-default pull-right'>";
