    ...
    class Product{
        ...
        function readAll($from_record_num, $records_per_page) {
            ...
            $query = "SELECT id, name, description, price, category_id "
                    . "FROM " . $this->table_name . " ORDER BY " . $orderWord . 
        ...
        function uploadPhoto() {
            ...
            if ($this->image) {
                ...
                // make sure that file is real image
                ...
                if (!in_array($file_type, $allowed_file_types)) {
                    $file_upload_error_messages .= "<div> Only jpg, jpeg, png, gif are allowed  </div>";
                }
                ...
                } else { /* if $file_upload_error_messages is NOT empty
